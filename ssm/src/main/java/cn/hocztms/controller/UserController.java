...
public class UserController {
    ...
    public void upload(String id,String username,HttpServletRequest request, HttpServletResponse response, MultipartFile upload) throws Exception {
    ...
    public void deletec(String id, HttpServletResponse response) throws Exception {
        response.setCharacterEncoding("UTF-8");
        response.setContentType("txt/html;charset=UTF-8");
    ...
    public @ResponseBody List<Folder> getf(String username,String fid, HttpServletResponse response) throws  Exception{
        ...
        try{
            return folderService.findfolder(username,fid);
        }catch (Exception e){
